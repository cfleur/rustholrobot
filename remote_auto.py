...
while cache == True:
    ...
    tank_pair.on_for_seconds(100, 100, 1.1)
    tank_pair.on_for_seconds(-100, 100, 1)
    tank_pair.on_for_seconds(100, 100, 0.8)
    tank_pair.on_for_seconds(100, -100, 1)
    tank_pair.on_for_seconds(100, 100, 3.2)
    tank_pair.on_for_seconds(-100, 100, 1)
    tank_pair.on_for_seconds(100, 100, 2.2)
    tank_pair.on_for_seconds(-100, 100, 0.5)
    tank_pair.on_for_seconds(100, 100, 0.5)
    tank_pair.on_for_seconds(-100, 100, 0.5)
    tank_pair.on_for_seconds(100, 100, 1.5)
    tank_pair.on_for_seconds(-100, 100, 2)
    tank_pair.on_for_seconds(100, 100, 0.8)
    tank_pair.on_for_seconds(-100, 100, 1)
    tank_pair.on_for_seconds(100, 100, 0.7)
    tank_pair.on_for_seconds(100, -100, 1)
    tank_pair.on_for_seconds(100, 100, 1.3)
    tank_pair.on_for_seconds(-100, 100, 1)
    tank_pair.on_for_seconds(100, 100, 2.7)
    tank_pair.on_for_seconds(-100, 100, 1)
    tank_pair.on_for_seconds(100, 100, 5)
    tank_pair.on_for_seconds(100, -100, 1)
    tank_pair.on_for_seconds(100, 100, 1.1)
    tank_pair.off()
    cache == False